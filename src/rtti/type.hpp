...
namespace rtti {
    ...
    public:
        ...
        bool is_copyable() const = 0;
        bool is_movable() const = 0;
        bool is_fundamental() const = 0;
        bool is_enum() const = 0;
        bool is_class() const = 0;
        ...
        virtual bool can_move_construct(const BufferRef& buff, const ObjectRef& src) const = 0;
